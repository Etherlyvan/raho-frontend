...
import {
  Building2, Users, LayoutDashboard, UserRound,
  FileText, Package, Stethoscope, Clipboard,
  FlaskConical, Boxes, ShoppingCart, Receipt,
  Bell, MessageSquare, BarChart3, ClipboardList,
...
const NAV_ITEMS: Record<RoleName, NavItem[]> = {
  ...
  ADMIN: [
    ...
    { label: "Inventori",       href: "/admin/inventory",      icon: Boxes },
  ...
  NURSE: [
    ...
    { label: "Stok Kritis",     href: "/nurse/inventory",      icon: FlaskConical },
...
export function AppSidebar() {
  ...
  // ✅ user.role sekarang RoleName — tidak ada error
  const items:  NavItem[] = NAV_ITEMS[user.role] ?? [];
    ...
    >
      ...
      <ScrollArea className="flex-1 py-3">
        <nav className="space-y-1 px-2">
          {/* ✅ item: NavItem — tidak ada implicit any */}
